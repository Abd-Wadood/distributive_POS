...
{
    /// <inheritdoc />
    public partial class InitialBranchCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Inventories_CurrentQuantity_NonNegative", "\"CurrentQuantity\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityChanged = table.Column<decimal>(type: "numeric(18,3)", precision: 18, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_TransactionType_ReferenceId",
                table: "InventoryTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseItems_PurchaseId_IngredientId",
                table: "PurchaseItems",
